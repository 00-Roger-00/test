    ...
    VFExt3.apply(VFExt3, {
        ...
        extend: function() {
            ...
            return function(f, c, d) {
                "object" == typeof c && (d = c,
                c = f,
                f = d.constructor != b ? d.constructor : function() {
        ...
        urlEncode: function(a, b) {
            var f, c = [], d = encodeURIComponent;
            VFExt3.iterate(a, function(a, b) {
                f = VFExt3.isEmpty(b);
                VFExt3.each(f ? a : b, function(b) {
                    c.push("\x26", d(a), "\x3d", !VFExt3.isEmpty(b) && (b != a || !f) ? VFExt3.isDate(b) ? VFExt3.encode(b).replace(/"/g, "") : d(b) : "")
                })
            });
            b || (c.shift(),
            b = "");
        ...
        urlDecode: function(a, b) {
            if (VFExt3.isEmpty(a))
                return {};
            var f = {}, c = a.split("\x26"), d = decodeURIComponent, h, m;
        ...
        each: function(a, b, f) {
            if (!VFExt3.isEmpty(a, !0)) {
                if (!VFExt3.isIterable(a) || VFExt3.isPrimitive(a))
                    a = [a];
                for (var c = 0, d = a.length; c < d; c++)
                    if (!1 === b.call(f || a[c], a[c], c, a))
                        return c
            }
        },
        iterate: function(a, b, f) {
            if (!VFExt3.isEmpty(a))
                if (VFExt3.isIterable(a))
                    VFExt3.each(a, b, f);
                else if ("object" == typeof a)
                    for (var c in a)
                        if (a.hasOwnProperty(c) && !1 === b.call(f || a, c, a[c], a))
                            break
        },
        getDom: function(b, f) {
            if (!b || !a)
        ...
        removeNode: p && !t ? function() {
            var b;
            return function(f) {
                f && "BODY" != f.tagName && (VFExt3.enableNestedListenerRemoval ? VFExt3.EventManager.purgeElement(f, !0) : VFExt3.EventManager.removeAll(f),
                b = b || a.createElement("div"),
                b.appendChild(f),
                b.innerHTML = "",
                delete VFExt3.elCache[f.id])
            }
        }() : function(a) {
            a && (a.parentNode && "BODY" != a.tagName) && (VFExt3.enableNestedListenerRemoval ? VFExt3.EventManager.purgeElement(a, !0) : VFExt3.EventManager.removeAll(a),
            a.parentNode.removeChild(a),
            delete VFExt3.elCache[a.id])
        }
        ,
        isEmpty: function(a, b) {
            return null === a || void 0 === a || VFExt3.isArray(a) && !a.length || (!b ? "" === a : !1)
        },
        isArray: function(a) {
...
VFExt3.apply(VFExt3, function() {
    ...
    return {
        ...
        addBehaviors: function(c) {
            if (VFExt3.isReady) {
                ...
                for (d in c)
                    if ((a = d.split("@"))[1])
                        e = a[0],
                        b[e] || (b[e] = VFExt3.select(e)),
                        b[e].on(a[1], c[d]);
                b = null
            } else
                VFExt3.onReady(function() {
        ...
        destroyMembers: function(c, b, a, d) {
            for (var e = 1, h = arguments, q = h.length; e < q; e++)
                VFExt3.destroy(c[h[e]]),
                delete c[h[e]]
        },
        clean: function(c) {
            var b = [];
        ...
        zip: function() {
            for (var c = VFExt3.partition(arguments, function(a) {
                ...
                if (d[e] = [],
                c)
                    d[e] = c.apply(c, VFExt3.pluck(b, e));
                else
                    for (var h = 0, q = b.length; h < q; h++)
                        d[e].push(b[h][e]);
            return d
        },
        getCmp: function(c) {
        ...
        type: function(c) {
            ...
            if ("object" == b || "function" == b) {
                ...
                if ("number" == typeof c.length && "function" == typeof c.item)
                    return "nodelist"
            }
            return b
        },
...
(function() {
    VFExt3.lib.Event = function() {
        ...
        var g = !1, k = {}, h = 0, q = [], f, m = !1, l = window, n = document, p = 20, s = "scrollLeft", t = "scrollTop", v = function() {
            return l.addEventListener ? function(a, b, c, f) {
                "mouseenter" == b ? (c = c.createInterceptor(d),
                a.addEventListener("mouseover", c, f)) : "mouseleave" == b ? (c = c.createInterceptor(d),
                a.addEventListener("mouseout", c, f)) : a.addEventListener(b, c, f);
                return c
            }
            ...
            addListener: function(a, b, c) {
                return (a = VFExt3.getDom(a)) && c ? "unload" == b ? (void 0 === k[a.id] && (k[a.id] = []),
                k[a.id].push([b, c]),
                c) : v(a, b, c, !1) : !1
            },
                    ...
                    if ("unload" == b) {
                        if (void 0 !== (m = k[a.id])) {
                            ...
                            for (d = m.length; f < d; f++)
                                (h = m[f]) && (h[0] == b && h[1] == c) && k[a.id].splice(f, 1)
                        }
                    } else
                        r(a, b, c, !1)
            },
            ...
            resolveTextNode: VFExt3.isGecko ? function(a) {
                if (a) {
                    var b = HTMLElement.prototype.toString.call(a);
                    if (!("[xpconnect wrapped native prototype]" == b || "[object XULElement]" == b))
            ...
            _unload: function(a) {
                var b = VFExt3.lib.Event, c, f, d, h, m, e;
                for (h in k) {
                    d = k[h];
                    c = 0;
                    for (m = d.length; c < m; c++)
                        if (f = d[c])
                            try {
                                e = f[3] ? !0 === f[3] ? f[2] : f[3] : l,
                                f[1].call(e, b.getEvent(a), f[2])
                            } catch (q) {}
                }
    ...
    VFExt3.lib.Ajax = function() {
        function d(a) {
            function b(a, f) {
                for (c in f)
                    f.hasOwnProperty(c) && a.setRequestHeader(c, f[c])
            }
            a = a.conn;
            var c;
            h.defaultHeaders && b(a, h.defaultHeaders);
            h.headers && (b(a, h.headers),
            delete h.headers)
        }
        function c(a, b) {
        ...
        function b(a, b) {
            var c = {}, d, h = a.conn, e, g, k = 1223 == h.status;
            try {
                d = a.conn.getAllResponseHeaders(),
                VFExt3.each(d.replace(/\r\n/g, "\n").split("\n"), function(a) {
                    e = a.indexOf(":");
                    0 <= e && (g = a.substr(0, e).toLowerCase(),
                    " " == a.charAt(e + 1) && ++e,
                    c[g] = a.substr(e + 1))
                })
            } catch (v) {}
        ...
        function a(a, c, d, e) {
            if (c) {
                ...
                if (200 <= g && 300 > g || VFExt3.isIE && 1223 == g)
                    e = b(a, c.argument),
                    c.success && (c.scope ? c.success.apply(c.scope, [e]) : c.success(e));
                else
                    switch (g) {
                    case 12002:
                    case 12029:
        ...
        function g(b, c) {
            ...
            g[e] = setInterval(function() {
                d && 4 == d.readyState && (clearInterval(g[e]),
                g[e] = null,
                k && (clearTimeout(h.timeout[e]),
                h.timeout[e] = null),
                a(b, c))
            }, h.pollInterval)
        }
        var k = ["MSXML2.XMLHTTP.3.0", "MSXML2.XMLHTTP", "Microsoft.XMLHTTP"]
          , h = {
            request: function(a, b, m, l, n) {
                if (n) {
                    ...
                    if (p || s) {
                        l = this.headers;
                        if (!l || !l["Content-Type"])
                            c("Content-Type", p ? "text/xml" : "application/json");
                ...
                if (t = t || null)
                    t.conn.open(a, b, !0),
                    h.useDefaultXhrHeader && c("X-Requested-With", h.defaultXhrHeader),
                    l && (h.useDefaultHeader && (!h.headers || !h.headers["Content-Type"])) && c("Content-Type", h.defaultPostHeader),
                    (h.defaultHeaders || h.headers) && d(t),
                    g(t, m),
                    t.conn.send(l || null);
                return t
            },
            serializeForm: function(a) {
                ...
                var b = !1, c = encodeURIComponent, d, h = "", e;
                VFExt3.each(a, function(a) {
                    d = a.name;
                    e = a.type;
                    if (!a.disabled && d)
                        if (/select-(one|multiple)/i.test(e))
                            VFExt3.each(a.options, function(a) {
                                a.selected && (h += String.format("{0}\x3d{1}\x26", c(d), c((a.hasAttribute ? a.hasAttribute("value") : null !== a.getAttribute("value")) ? a.value : a.text)))
                            });
                        else if (!/file|undefined|reset|button/i.test(e) && (!/radio|checkbox/i.test(e) || a.checked) && !("submit" == e && b))
                            h += c(d) + "\x3d" + c(a.value) + "\x26",
                            b = /submit/i.test(e)
                });
            ...
            abort: function(b, c, d) {
                var e = b.tId
                  , g = !1;
                this.isCallInProgress(b) && (b.conn.abort(),
                clearInterval(this.poll[e]),
                this.poll[e] = null,
                clearTimeout(h.timeout[e]),
                this.timeout[e] = null,
                a(b, c, g = !0, d));
                return g
            },
...
(function() {
    ...
    function b(b, c, d, e) {
        return function() {
            ...
            d.tasks || (d.tasks = []);
            d.tasks.push(g);
            g.delay(c.delay || 10, b, e, Array.prototype.slice.call(arguments, 0))
        }
    }
    var a = VFExt3.util
      , g = VFExt3.each;
    ...
    a.Observable.prototype = {
        ...
        fireEvent: function() {
            var a = Array.prototype.slice.call(arguments, 0), b = a[0].toLowerCase(), c = !0, d = this.events[b], e;
            if (!0 === this.eventsSuspended)
                (e = this.eventQueue) && e.push(a);
            else if ("object" == typeof d)
                if (d.bubble) {
                    if (!1 === d.fire.apply(d, a.slice(1)))
                        return !1;
                    if ((d = this.getBubbleTarget && this.getBubbleTarget()) && d.enableBubble)
                        return c = d.events[b],
                        (!c || "object" != typeof c || !c.bubble) && d.enableBubble(b),
                        d.fireEvent.apply(d, a)
                } else
                    a.shift(),
                    c = d.fire.apply(d, a);
            return c
        ...
        addListener: function(b, c, d, e) {
            ...
            if ("object" == typeof b)
                ...
                e)
                    b = e[g],
                    this.filterOptRe.test(g) || this.addListener(g, b.fn || b, b.scope || e.scope, b.fn ? b : e);
            else
                b = b.toLowerCase(),
                g = this.events[b] || !0,
                "boolean" == typeof g && (this.events[b] = g = new a.Event(this,b)),
                g.addListener(c, d, "object" == typeof e ? e : {})
        },
        removeListener: function(a, b, c) {
        ...
        purgeListeners: function() {
            var a = this.events, b, c;
            for (c in a)
                b = a[c],
                "object" == typeof b && b.clearListeners()
        },
        addEvents: function(a) {
            this.events = this.events || {};
            if ("string" == typeof a)
                for (var b = arguments, c = b.length; c--; )
                    this.events[b[c]] = this.events[b[c]] || !0;
            else
                VFExt3.applyIf(this.events, a)
        },
    ...
    a.Event.prototype = {
        addListener: function(a, b, c) {
            b = b || this.obj;
            this.isListening(a, b) || (a = this.createListener(a, b, c),
        ...
        findListener: function(a, b) {
            var c = this.listeners, d = c.length, e;
            for (b = b || this.obj; d--; )
                if ((e = c[d]) && e.fn == a && e.scope == b)
                    return d;
            return -1
        },
        ...
        clearListeners: function() {
            for (var a = this.listeners, b = a.length; b--; )
                this.removeListener(a[b].fn, a[b].scope)
        },
        fire: function() {
            var a = this.listeners, b = a.length, c = 0, d;
            if (0 < b) {
                this.firing = !0;
                for (var e = Array.prototype.slice.call(arguments, 0); c < b; c++)
                    if ((d = a[c]) && !1 === d.fireFn.apply(d.scope || this.obj || window, e))
...
VFExt3.EventManager = function() {
    function d(a) {
        var b = !1, c = 0, d = z.length, e = b = !1, f;
        if (a) {
            if (a.getElementById || a.navigator) {
                ...
                b = VFExt3.id(a);
            VFExt3.elCache[b] || (VFExt3.Element.addToCache(new VFExt3.Element(a), b),
            e && (VFExt3.elCache[b].skipGC = !0))
        }
        return b
    }
    function e(a, b, c, e, f, g) {
        a = VFExt3.getDom(a);
        var h = d(a), h = VFExt3.elCache[h].events, m;
        m = v.on(a, b, f);
        h[b] = h[b] || [];
        h[b].push([c, f, g, m, e]);
        if (a.addEventListener && "mousewheel" == b) {
    ...
    function a(a) {
        ...
        if (A.length == r.styleSheets.length)
            return k(),
            !0;
        s || (p = setTimeout(arguments.callee, 2));
        return !1
    ...
    function k(a) {
        s || (s = !0,
        p && clearTimeout(p),
        t && r.removeEventListener(x, k, !1),
        VFExt3.isIE && b.bindIE && VFExt3.IE.removeEvent(r, "onreadystatechange", b),
        v.un(u, "load", arguments.callee));
        n && !VFExt3.isReady && (VFExt3.isReady = !0,
        n.fire(),
        n.listeners = [])
    }
    function h(a, b) {
        return function() {
            ...
            b.target == VFExt3.EventObject.setEvent(c[0]).target && a.apply(this, c)
        }
    }
    function q(a, b, c) {
        return function(d) {
    ...
    function l(a, b, c, d, g) {
        ...
        var l = !c || "boolean" == typeof c ? {} : c, n = VFExt3.getDom(a), p;
        d = d || l.fn;
        g = g || l.scope;
        if (!n)
            throw 'Error listening for "' + b + '". Element "' + a + "\" doesn't exist.";
        l.target && (k = h(k, l));
        l.delay && (k = m(k, l, d));
        l.single && (k = f(k, n, b, d, g));
        l.buffer && (p = new VFExt3.util.DelayedTask(k),
        k = q(k, l, p));
        e(n, b, d, p, k, g);
        return k
    }
    var n, p, s = !1, t = VFExt3.isGecko || VFExt3.isWebKit || VFExt3.isSafari, v = VFExt3.lib.Event, r = document, u = window, x = "DOMContentLoaded", y = "complete", B = /^(?:scope|delay|buffer|single|stopEvent|preventDefault|stopPropagation|normalized|args|delegate)$/, z = [], A, w = {
        addListener: function(a, b, c, d, e) {
            if ("object" == typeof b)
                for (var f in b)
                    c = b[f],
                    B.test(f) || (VFExt3.isFunction(c) ? l(a, f, b, c, b.scope) : l(a, f, c));
            else
                l(a, b, e, c, d)
        },
        removeListener: function(a, b, c, e) {
            a = VFExt3.getDom(a);
            var f = d(a), g = a && VFExt3.elCache[f].events[b] || [], h, m, k;
            h = 0;
            for (m = g.length; h < m; h++)
                if (VFExt3.isArray(k = g[h]) && k[0] == c && (!e || k[2] == e)) {
                    ...
                    for (e in VFExt3.elCache[f].events)
                        return !1;
        ...
        removeAll: function(a) {
            a = VFExt3.getDom(a);
            var b = d(a), c = (VFExt3.elCache[b] || {}).events || {}, e, f, g, h, k, m, l;
            for (h in c)
            ...
            VFExt3.elCache[b] && (VFExt3.elCache[b].events = {})
        },
        getListeners: function(a, b) {
            a = VFExt3.getDom(a);
            var c = d(a);
        ...
        purgeElement: function(a, b, c) {
            a = VFExt3.getDom(a);
            var e = d(a), e = (VFExt3.elCache[e] || {}).events || {}, f, g;
            if (c) {
                if (e && e.hasOwnProperty(c)) {
                    f = e[c];
                    e = 0;
                    for (g = f.length; e < g; e++)
                        VFExt3.EventManager.removeListener(a, c, f[e][0])
                }
            } else
                VFExt3.EventManager.removeAll(a);
            if (b && a && a.childNodes) {
                e = 0;
                for (g = a.childNodes.length; e < g; e++)
                    VFExt3.EventManager.purgeElement(a.childNodes[e], b, c)
            }
        },
        _unload: function() {
            for (var a in VFExt3.elCache)
                VFExt3.EventManager.removeAll(a);
        ...
        onDocumentReady: function(c, d, e) {
            VFExt3.isReady ? (n || (n = new VFExt3.util.Event),
            n.addListener(c, d, e),
            n.fire(),
            n.listeners = []) : (n || (n || (n = new VFExt3.util.Event),
            t && r.addEventListener(x, k, !1),
            VFExt3.isIE ? b() || (b.bindIE = !0,
            VFExt3.IE.addEvent(r, "onreadystatechange", b)) : VFExt3.isOpera ? r.readyState == y && a() || r.addEventListener(x, g, !1) : VFExt3.isWebKit && b(),
            v.on(u, "load", k)),
            e = e || {},
            e.delay = e.delay || 1,
            n.addListener(c, d, e))
...
VFExt3.EventObject = function() {
    ...
    VFExt3.EventObjectImpl.prototype = {
        setEvent: function(a) {
            if (a == this || a && a.browserEvent)
                return a;
            (this.browserEvent = a) ? (this.button = a.button ? b[a.button] : a.which ? a.which - 1 : -1,
            e.test(a.type) && -1 == this.button && (this.button = 0),
            this.type = a.type,
            this.shiftKey = a.shiftKey,
            this.ctrlKey = a.ctrlKey || a.metaKey || !1,
            this.altKey = a.altKey,
            this.keyCode = a.keyCode,
            this.charCode = a.charCode,
            this.target = d.getTarget(a),
            this.xy = d.getXY(a)) : (this.button = -1,
            this.altKey = this.ctrlKey = this.shiftKey = !1,
        ...
        stopEvent: function() {
            this.browserEvent && ("mousedown" == this.browserEvent.type && VFExt3.EventManager.stoppedMouseDownEvent.fire(this),
            d.stopEvent(this.browserEvent))
        },
        ...
        stopPropagation: function() {
            this.browserEvent && ("mousedown" == this.browserEvent.type && VFExt3.EventManager.stoppedMouseDownEvent.fire(this),
            d.stopPropagation(this.browserEvent))
        },
        ...
        within: function(a, b, c) {
            return a ? (b = this[b ? "getRelatedTarget" : "getTarget"]()) && ((c ? b == VFExt3.getDom(a) : !1) || VFExt3.fly(a).contains(b)) : !1
        }
    };
    ...
    VFExt3.extend(VFExt3.data.Connection, VFExt3.util.Observable, {
        ...
        request: function(b) {
            if (this.fireEvent("beforerequest", this, b)) {
                b.el && (VFExt3.isEmpty(b.indicatorText) || (this.indicatorText = '\x3cdiv class\x3d"loading-indicator"\x3e' + b.indicatorText + "\x3c/div\x3e"),
                this.indicatorText && (VFExt3.getDom(b.el).innerHTML = this.indicatorText),
                b.success = (VFExt3.isFunction(b.success) ? b.success : function() {}
                ).createInterceptor(function(a) {
                    VFExt3.getDom(b.el).innerHTML = a.responseText
                }));
                var a = b.params, d = b.url || this.url, e, h = {
                ...
                a = VFExt3.urlEncode(this.extraParams, VFExt3.isObject(a) ? VFExt3.urlEncode(a) : a);
                VFExt3.isFunction(d) && (d = d.call(b.scope || c, b));
                if (e = VFExt3.getDom(b.form)) {
                    d = d || e.action;
                    if (b.isUpload || /multipart\/form-data/i.test(e.getAttribute("enctype")))
                        return this.doFormUpload.call(this, b, a, d);
                    e = VFExt3.lib.Ajax.serializeForm(e);
                    a = a ? a + "\x26" + e : e
                }
                e = b.method || this.method || (a || b.xmlData || b.jsonData ? "POST" : "GET");
                if ("GET" === e && this.disableCaching && !1 !== b.disableCaching || !0 === b.disableCaching)
                    d = VFExt3.urlAppend(d, (b.disableCachingParam || this.disableCachingParam) + "\x3d" + (new Date).getTime());
                b.headers = VFExt3.apply(b.headers || {}, this.defaultHeaders || {});
                (!0 === b.autoAbort || this.autoAbort) && this.abort();
                if (("GET" == e || b.xmlData || b.jsonData) && a)
                    d = VFExt3.urlAppend(d, a),
                    a = "";
        ...
        abort: function(b) {
            if (b || this.isLoading())
                VFExt3.lib.Ajax.abort(b || this.transId)
        },
        ...
        doFormUpload: function(b, a, g) {
            function k() {
                ...
                try {
                    if (m = f.contentWindow.document || f.contentDocument || c.frames[h].document)
                        m.body && (/textarea/i.test((l = m.body.firstChild || {}).tagName) ? g.responseText = l.value : g.responseText = m.body.innerHTML),
                        g.responseXML = m.XMLDocument || m
                } catch (n) {}
            ...
            var h = VFExt3.id(), q = document, f = q.createElement("iframe"), m = VFExt3.getDom(b.form), l = [], n, p = {
                target: m.target,
                method: m.method,
                encoding: m.encoding,
                enctype: m.enctype,
...
VFExt3.util.JSON = new function() {
    var d = !!{}.hasOwnProperty
      ...
      , a = function(b) {
        if (!VFExt3.isDefined(b) || null === b)
            return "null";
        if (VFExt3.isArray(b)) {
            var c = ["["], e, g, l = b.length, n;
            for (g = 0; g < l; g += 1)
                switch (n = b[g],
                typeof n) {
                case "undefined":
                ...
                default:
                    e && c.push(","),
                    c.push(null === n ? "null" : VFExt3.util.JSON.encode(n)),
                    e = !0
                }
            c.push("]");
            return c.join("")
        ...
        if (VFExt3.isDate(b))
            return VFExt3.util.JSON.encodeDate(b);
        if (VFExt3.isString(b))
            return k(b);
        if ("number" == typeof b)
            return isFinite(b) ? String(b) : "null";
        if (VFExt3.isBoolean(b))
            return String(b);
        e = ["{"];
        for (g in b)
            if (!b.getElementsByTagName && (!d || b.hasOwnProperty(g)))
                switch (l = b[g],
                typeof l) {
                case "undefined":
                case "function":
...
VFExt3.Direct = VFExt3.extend(VFExt3.util.Observable, {
    ...
    addProvider: function(d) {
        ...
        if (1 < e.length)
            for (var c = 0, b = e.length; c < b; c++)
                this.addProvider(e[c]);
        else
            return d.events || (d = new VFExt3.Direct.PROVIDERS[d.type](d)),
            d.id = d.id || VFExt3.id(),
    ...
    onProviderData: function(d, e) {
        if (VFExt3.isArray(e))
            for (var c = 0, b = e.length; c < b; c++)
                this.onProviderData(d, e[c]);
        else
            e.name && "event" != e.name && "exception" != e.name ? this.fireEvent(e.name, e) : "exception" == e.type && this.fireEvent("exception", e),
            this.fireEvent("event", e, d)
    },
    ...
    getEvents: function(d, e) {
        ...
        try {
            ...
            if (e && e.transaction && VFExt3.isArray(e.transaction))
                for (var g = 0, k = e.transaction.length; g < k; g++) {
                    var h = VFExt3.apply({
        ...
        if (VFExt3.isArray(c)) {
            ...
            for (k = c.length; g < k; g++)
                b.push(VFExt3.Direct.createEvent(c[g]))
        } else if (e && e.transaction && VFExt3.isArray(e.transaction)) {
            g = 0;
            for (k = e.transaction.length; g < k; g++)
                h = VFExt3.apply({
                    tid: e.transaction[g].tid
                }, c),
                b.push(VFExt3.Direct.createEvent(h))
        } else
            b.push(VFExt3.Direct.createEvent(c));
        return b
    }
});
VFExt3.direct.RemotingProvider = VFExt3.extend(VFExt3.direct.JsonProvider, {
    ...
    initAPI: function() {
        var d = this.actions, e;
        for (e in d)
            for (var c = this.namespace[e] || (this.namespace[e] = {}), b = d[e], a = 0, g = b.length; a < g; a++) {
                var k = b[a];
    ...
    onData: function(d, e, c) {
        if (e) {
            ...
            for (var b = c.length; e < b; e++) {
                ...
                g && (this.doCallback(g, a, !0),
                VFExt3.Direct.removeTransaction(g))
            }
        } else {
            d = [].concat(d.transaction);
            e = 0;
            for (b = d.length; e < b; e++)
                (g = this.getTransaction(d[e])) && g.retryCount < this.maxRetries ? g.retry() : (a = new VFExt3.Direct.ExceptionEvent({
                    data: a,
                    transaction: g,
    ...
    doSend: function(d) {
        ...
        if (VFExt3.isArray(d)) {
            ...
            for (var b = 0, a = d.length; b < a; b++)
                c.push(this.getCallData(d[b]))
        } else
            c = this.getCallData(d);
        this.enableUrlEncode ? (d = {},
        d[VFExt3.isString(this.enableUrlEncode) ? this.enableUrlEncode : "data"] = VFExt3.encode(c),
        e.params = d) : e.jsonData = c;
        VFExt3.Ajax.request(e)
    },
    combineAndSend: function() {
        var d = this.callBuffer.length;
        0 < d && (this.doSend(1 == d ? this.callBuffer[0] : this.callBuffer),
        this.callBuffer = [])
    },
    queueTransaction: function(d) {
        d.form ? this.processForm(d) : (this.callBuffer.push(d),
        this.enableBuffer ? (this.callTask || (this.callTask = new VFExt3.util.DelayedTask(this.combineAndSend,this)),
        this.callTask.delay(VFExt3.isNumber(this.enableBuffer) ? this.enableBuffer : 10)) : this.combineAndSend())
    },
    doCall: function(d, e, c) {
        ...
        !1 !== this.fireEvent("beforecall", this, d, e) && (VFExt3.Direct.addTransaction(d),
        this.queueTransaction(d),
        this.fireEvent("call", this, d, e))
    },
    ...
    doCallback: function(d, e) {
        ...
        if (d && d.cb) {
            ...
            VFExt3.isFunction(b) ? b(a, e) : (VFExt3.callback(b[c], b.scope, [a, e]),
            VFExt3.callback(b.callback, b.scope, [a, e]))
        }
    }
});
...
VFExt3.util.Format = function() {
    ...
    return {
        ...
        usMoney: function(a) {
            ...
            var b = a.split(".");
            a = b[0];
            for (var b = b[1] ? "." + b[1] : ".00", c = /(\d+)(\d{3})/; c.test(a); )
                a = a.replace(c, "$1,$2");
            a += b;
        ...
        round: function(a, b) {
            var c = Number(a);
            "number" == typeof b && (b = Math.pow(10, b),
            c = Math.round(a * b) / b);
            return c
        },
        number: function(a, b) {
            ...
            var c = ","
              ...
              , f = 0 > a;
            a = Math.abs(a);
            "/i" == b.substr(b.length - 2) && (b = b.substr(0, b.length - 2),
            e = !0,
            c = ".",
            d = ",");
            var m = -1 != b.indexOf(c)
            ...
            if (1 < e.length)
                a = a.toFixed(e[1].length);
            else {
                if (2 < e.length)
                    throw "NumberFormatException: invalid format, formats should have no more than 1 period: " + b;
                a = a.toFixed(0)
            }
            var l = a.toString()
              , e = l.split(".");
            if (m) {
                for (var m = e[0], l = [], n = m.length, p = m.length % 3 || 3, s = 0; s < n; s += p)
                    0 != s && (p = 3),
                    l[l.length] = m.substr(s, p);
                l = l.join(c);
                e[1] && (l += d + e[1])
            } else
                e[1] && (l = e[0] + d + e[1]);
...
(function() {
    ...
    VFExt3.Element = function(a, b) {
        var c = "string" == typeof a ? d.getElementById(a) : a, e;
        if (!c)
            return null;
        e = c.id;
        if (!b && e && VFExt3.elCache[e])
            return VFExt3.elCache[e].el;
        this.dom = c;
    ...
    c.prototype = {
        set: function(a, b) {
            ...
            for (d in a)
                a.hasOwnProperty(d) && (g = a[d],
                "style" == d ? e.applyStyles(c, g) : "cls" == d ? c.className = g : b ? c.setAttribute(d, g) : c[d] = g);
            return this
        },
        defaultUnit: "px",
        is: function(a) {
        ...
        addUnits: function(a) {
            if ("" === a || "auto" == a || void 0 === a)
                a = a || "";
            else if (!isNaN(a) || !g.test(a))
                a += this.defaultUnit || "px";
            return a
        },
        load: function(a, b, c) {
    ...
    a.autoBoxAdjust = !0;
    var g = /\d+(px|em|%|en|ex|pt|in|cm|mm|pc)$/i, k;
    c.get = function(a) {
        var e, g;
        if (!a)
            return null;
        if ("string" == typeof a) {
            if (!(g = d.getElementById(a)))
                return null;
            b[a] && b[a].el ? (e = b[a].el,
            e.dom = g) : e = c.addToCache(new c(g));
            return e
        }
        if (a.tagName) {
            if (!(e = a.id))
                e = VFExt3.id(a);
            b[e] && b[e].el ? (e = b[e].el,
            e.dom = a) : e = c.addToCache(new c(a));
            return e
        }
        return a instanceof c ? (a != k && (a.dom = VFExt3.isIE && (void 0 == a.id || "" == a.id) ? a.dom : d.getElementById(a.id) || a.dom),
        a) : a.isComposite ? a : VFExt3.isArray(a) ? c.select(a) : a == d ? (k || (a = function() {}
        ,
    ...
    c.collectorThreadId = setInterval(function() {
        if (VFExt3.enableGarbageCollector) {
            ...
            for (a in b)
                ...
                !e.skipGC && (e = e.el,
                e = e.dom,
                !e || !e.parentNode || !e.offsetParent && !d.getElementById(a)))
                    VFExt3.enableListenerCollection && VFExt3.EventManager.removeAll(e),
                    delete b[a];
            if (VFExt3.isIE) {
                e = {};
                for (a in b)
    ...
    c.fly = function(a, b) {
        var d = null;
        b = b || "_global";
        if (a = VFExt3.getDom(a))
            (c._flyweights[b] = c._flyweights[b] || new c.Flyweight).dom = a,
            d = c._flyweights[b];
        return d
    }
    ;
...
$VFRM.Util = {
    ...
    __resolveRefs: function(a, b, c) {
        if (this.isArray(a)) {
            for (var d = c || [], g = 0; g < a.length; g++)
                d.push(this.__resolveRefs(a[g], b));
            return d
        }
        if (this.isObject(a)) {
            d = a.s;
            if (void 0 !== d)
                ...
                g = this.isArray(a) ? [] : {},
                b[d] = g,
                this.__resolveRefs(a, b, g);
            d = a.r;
            if (void 0 !== d)
                return b[d];
            d = c || {};
            for (g in a)
                d[g] = this.__resolveRefs(a[g], b);
            return d
        }
        return a
    },
    ...
    getObject: function(a, b) {
        ...
        if (-1 < a.indexOf(".")) {
            c = a.split(".");
            for (var d = c.pop(), g = 0; g < c.length; g++)
                b = b[c[g]]
        }
        return b[d]
    },
    ...
    get: function(a) {
        if (a = RegExp("[?\x26]" + encodeURIComponent(a) + "\x3d([^\x26]*)").exec(location.search))
...
$VFRM.RemotingProviderImpl = VFExt3.extend(VFExt3.direct.RemotingProvider, {
    constructor: function(a) {
        ...
        if (!a.vf)
            throw g + "Visualforce configuration not provided";
        var m = a.vf
          , p = m.dbg || m.tst || "yes" === d.get("__vfrmtdbg");
        this.id = m.vid;
        this.pageUri = m.vn;
        this.timestamp = m.tm;
        this.ns = m.ns;
        ...
        this.reInit = function(a, b) {
            ...
            b && d.isFunction(b) && b(!0, this)
        }
        ;
        this.initAPI = function() {
            var a = c.actions, l, e, f, k;
            for (k in a) {
                l = 1 === a[k].prm;
                e = m.dev;
                f = m.tst;
                var n = m.ovrprm;
                if (top !== self && l && (!e || top.document.location.pathname !== self.document.location.pathname) && !f && !n)
                    a[k] = null,
                    l = "Javascript proxies were not generated for controller " + k + ": may not use public remoted methods inside an iframe.",
                    InternalDialogs.showAlert(l),
                    b(l);
                else {
                    f = k.indexOf(".");
                    l = a[k].ms;
                    -1 < f ? (e = k.substring(0, f),
                    e = c.namespace[e] || (c.namespace[e] = {}),
                    f = k.substring(f + 1),
                    f = e[f] || (e[f] = {})) : f = c.namespace[k] || (c.namespace[k] = {});
                    for (var n = 0, q = l.length; n < q; n++)
                        e = l[n],
                        f[e.name] && !m.xhr ? d.error(g + ("Unable to create method '" + e.name + "': already exists on object '" + k + "'"), void 0) : f[e.name] = c.createMethod(k, e);
                    p && d.log(g + k, f)
                }
            }
        }
        ...
        this.doCall = function(a, b, e) {
            p && ("undefined" !== typeof console && console.time) && console.time("VF Remoting: " + b.name);
            if (d.isFunction(e[b.len])) {
                ...
                d.error(g + ("Parameter length does not match remote action parameters: expected " + b.len + " parameters, got "), void 0)
        }
        ;
        this.isRemotingTx = function(b) {
            return b && b.scope.service == a.service
        }
        ;
        this.setTimeout = function(a) {
            var b;
            a.transaction && a.transaction.args && (b = a.transaction.args[a.transaction.args.length - 1],
            d.isObject(b) && b.timeout && (a.timeout = b.timeout));
        ...
        this.refresh = function(a) {
            ...
            for (e in this.actions)
                if (this.actions[e].ms)
                    for (var f = 0, k = this.actions[e].ms.length; f < k; f++)
                        c[e + "." + this.actions[e].ms[f].name] = this.actions[e].ms[f];
            a = {
                url: this.url,
                success: function(a) {
                    return function(c) {
                        var e, l = VFExt3.decode(c.responseText), f, k = !0;
                        if (l.actions)
                            if (f = VFExt3.decode(l.actions),
                            !f || !d.isObject(f))
                                d.error(g + "Unable to refresh actions: actions result not found or not an object", void 0);
                            else {
                                for (var h in f)
                                    if (e = h.substring(0, h.lastIndexOf(".")),
                                    c = this.actions[e],
                                    !c || !c.ms)
                                        b("Unable to refresh action '" + h + "', controller '" + e + "' not found"),
                                        k = !1;
                                    else {
                                        e = 0;
                                        for (var m = c.ms.length; e < m; e++)
                                            if (c.ms[e].name === h.substring(h.lastIndexOf(".") + 1)) {
                                                c.ms[e].csrf = f[h];
                                                p && d.log(g + ("Refreshed action '" + h + "'"), void 0);
                                                break
                                            }
                                    }
                            ...
                            d.error(g + "Unable to refresh actions: actions result not found", void 0)
                    }
                }(a),
                failure: function(a) {
                    return function(b) {
        ...
        this.getCallData = function(a) {
            var b = $VFRM.RemotingProviderImpl.superclass.getCallData.call(this, a) || {};
            b.ctx = a.ctx;
            return b
        }
        ;
        this.addListener("beforecall", function(a, c, e) {
            h(c) ? b("Context not applied") : (c.ctx = {
                csrf: e.csrf,
                vid: m.vid,
                ns: e.ns,
                ver: e.ver,
            ...
            h(c.ctx.csrf) && b("Context incomplete - CSRF not provided", c.ctx),
            h(c.ctx.vid) && b("Context incomplete - Visualforce id not provided", c.ctx),
            ("undefined" === typeof c.ctx.ns || null === c.ctx.ns) && b("Context incomplete - namespace not provided", c.ctx),
            h(c.ctx.ver) && b("Context incomplete - version not provided", c.ctx),
            h(c.ctx.authorization) && b("Context incomplete - authorization not provided", c.ctx),
            p && d.log(g + "Added context to transaction request", c))
        });
        this.addListener("data", function(a, b) {
            if (!h(a) && !h(b)) {
                "undefined" === typeof b.result && (b.result = null);
                var e = b.getTransaction()
                  , f = !h(e) && !h(e.args) && d.isObject(e.args[e.args.length - 1]) ? e.args[e.args.length - 1] : null;
                p && c.fireEvent("beforedata", this, b);
                if (h(f) || h(f.escape) || !0 === f.escape)
                    b.result = d.htmlEncode(b.result);
                !0 === b.ref && (b.result = d.resolveRefs(b.result));
                p && d.log(g + "Response result", b.result);
                p && ("undefined" !== typeof console && console.timeEnd) && console.timeEnd("VF Remoting: " + b.method);
                if (!h(e) && d.isFunction(e.cb)) {
                    var k = e.cb;
                    e.cb = function(a, b) {
...
VFExt3.Ajax.on("beforerequest", function(a, b) {
    $VFRM.last.isRemotingTx(b) && (b.headers || (b.headers = {}),
    $VFRM.Util.isNotEmpty($VFRM.oauthAccessToken) && $VFRM.Util.isString($VFRM.oauthAccessToken) && (b.headers.Authorization = "OAuth " + $VFRM.oauthAccessToken),
    b.headers["X-User-Agent"] = "Visualforce-Remoting",
    $VFRM.last.setTimeout(b))
}, this);
$VFRM.ProviderManager = VFExt3.extend(VFExt3.util.Observable, {
    ...
    providers: {},
    add: function(a) {
        !1 !== this.fireEvent("beforeadd", a) && (VFExt3.Direct.addProvider(a),
        this.providers[a.id] = a,
        $VFRM.last = a,
        this.fireEvent("afteradd", a))
    },
    get: function(a) {
    ...
    on: function(a, b) {
        if (this.events[a])
            $VFRM.ProviderManager.superclass.on.call(this, a, b);
        else
            for (var c in this.providers)
                this.providers[c].on(a, b)
    },
    getController: function(a) {
        if (!a || !$VFRM.Util.isString(a))
            return null;
        var b = $VFRM.Util.getObject(a);
        if (!b)
            for (var c in this.providers)
                b && $VFRM.Util.warn("Multiple remoting controllers found for '" + a + "'"),
                this.providers[c].ns && (b = $VFRM.Util.getObject(this.providers[c].ns + "." + a));
        (!b || !$VFRM.Util.isObject(b)) && $VFRM.Util.warn("Controller not found for '" + a + "'");
        return b
    },
    getAction: function(a) {
        if (!a || !$VFRM.Util.isString(a) || -1 == a.indexOf("."))
            return null;
        var b = this.getController(a.substring(0, a.lastIndexOf("."))), c;
        b && (c = b[a.substring(a.lastIndexOf(".") + 1)],
        (!c || !$VFRM.Util.isFunction(c)) && $VFRM.Util.warn("Action function not found for '" + a + "'"));
        return c
    },
    invokeAction: function() {
        ...
        var a = Array.prototype.shift.call(arguments)
          , b = this.getAction(a);
        b && $VFRM.Util.isFunction(b) ? b.apply(this, arguments) : $VFRM.Util.error("Unable to invoke action '" + a + "': no controller and/or function found", null)
    }
});
